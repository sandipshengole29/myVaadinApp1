...
import com.myVaadinApp1.repository.PhoneType;
...
public class ContactDetailView extends VerticalLayout {
	private static Logger LOGGER = LoggerFactory.getLogger(ContactDetailView.class);
	...
	public ContactDetailView() {
		LOGGER.info("======= inside ContactDetailView of ContactDetailView =======");
	...
	private void bindingFields() {
		LOGGER.info("======= inside bindingFields of ContactDetailView =======");
	...
	private HorizontalLayout nameRow() {
		LOGGER.info("======= inside nameRow of ContactDetailView =======");
	...
	private HorizontalLayout phoneRow() {
		LOGGER.info("======= inside phoneRow of ContactDetailView =======");
		HorizontalLayout sample = new HorizontalLayout();
		sample.addStyleName(OUTLINED);
		sample.setSpacing(false);
		sample.setMargin(false);
	...
	private HorizontalLayout emailRow() {
		LOGGER.info("======= inside emailRow of ContactDetailView =======");
		HorizontalLayout sample = new HorizontalLayout();
		sample.addStyleName(OUTLINED);
		sample.setSpacing(false);
		sample.setMargin(false);
	...
	public final void showDetail(Contact c) {
		LOGGER.info("======= inside showDetail of ContactDetailView =======");
		contact = c;
	...
	public void setChangeHandler(ChangeHandler h) {
		LOGGER.info("======= inside setChangeHandler of ContactDetailView =======");
